...
public final class SimpleMapTest {
    ...
    private SimpleMapTest(final int threadCount, final int entryCount, final int valueSize,
                          final int getPercentage, final int putPercentage, final boolean load, boolean isSimple) {
    ...
    private Map<String, Object> getMap() {
        return isSimple ? instance.getDistributedObject(SERVICE_NAME, NAMESPACE) : instance.getMap(NAMESPACE);
    }
    ...
    public static void main(String[] input) throws InterruptedException {
        ...
        SimpleMapTest test = new SimpleMapTest(threadCount, entryCount, valueSize, getPercentage, putPercentage, load, isSimple);
        test.start();
    }
